(function(module) {
     ...
     * @param {Function} unserializer Unserializer that receives serialized key and returns key in callback
     */
     ...
     * @param {Function} unserializer Unserializer that receives serialized value and returns value in callback
     */
